# coursework
PureLoop
Название передает идею чистоты и замкнутого цикла, что соответствует принципам экологичности и устойчивого потребления. "Loop" символизирует непрерывный цикл, как в природе, где каждый продукт можно использовать ответственно и многократно, а "Pure" — ассоциацию с натуральными и безопасными товарами.
